...
const mockOwnerEasers = [
  {
    ...
    contractor_agreement_signed_at: iso(-180 * 86400000), contractor_agreement_version: '2026-08-16',
  ...
  },
  {
    ...
    contractor_agreement_signed_at: iso(-75 * 86400000), contractor_agreement_version: '2026-08-16',
    stripe_connect_account_id: null, stripe_connect_onboarding_complete: false, stripe_connect_details_submitted: false,
  ...
  },
  {
    ...
    contractor_agreement_signed_at: iso(-4 * 86400000), contractor_agreement_version: '2026-08-16',
    stripe_connect_account_id: null, stripe_connect_onboarding_complete: false, stripe_connect_details_submitted: false,
...
const mockProfile = {
  ...
  contractor_agreement_signed_at: '2026-07-13T14:00:00.000Z', contractor_agreement_version: '2026-08-16',
...
const mockManualPayoutReadiness = {
  ...
  tier: 'professional',
  currentAgreementVersion: '2026-08-16',
  missingItems: [],
  isReady: true,
