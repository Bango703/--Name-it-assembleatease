...
const easerCriticalAssetVersion = '20260818a';
...
assert.match(easerProfileSource, />Profile completion</, 'Profile completion meter must remain clearly labeled');
assert.match(easerProfileSource, /Your profile information is complete\./, 'Profile completion copy must describe profile information, not canonical job readiness');
assert.match(easerProfileSource, /id=['"]account-status-notice['"]/, 'Job-readiness blockers must remain separate from profile completion');
