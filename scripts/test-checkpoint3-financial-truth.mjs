...
assert.match(readiness, /REQUIRED_SCHEMA_MIGRATION\s*=\s*53/);
assert.match(readiness, /DATABASE_SCHEMA_053/);
assert.match(readiness, /Apply migrations 038-053 in order/);
