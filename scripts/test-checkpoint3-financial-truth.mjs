...
assert.match(readiness, /REQUIRED_SCHEMA_MIGRATION\s*=\s*67/);
assert.match(readiness, /DATABASE_SCHEMA_067/);
assert.match(readiness, /Apply migrations 038-067 in order/);
