...
Implemented: a gated callback-request/catalog API and Easer-completion notification/timeline fixes. The owner approved a scoped preview push on 2026-09-06. This release is intended for branch `fix/sora-owner-intake-preview`, not a production promotion. No live AI intake, tool attachment, call-routing change, SQL change or deletion is part of this release. Push/build verification is reported separately after publication. The implementation is not end-to-end certified.
