...
assert.match(readiness, /REQUIRED_SCHEMA_MIGRATION\s*=\s*44/);
assert.match(readiness, /DATABASE_SCHEMA_044/);
assert.match(readiness, /Apply migrations 038-044 in order/);
