...
<section style="background:linear-gradient(135deg,#f0fdff 0%,#e0f7fa 50%,#f9fafb 100%);padding:4.5rem 2rem 3.5rem;border-bottom:1px solid var(--border)">
  <div style="max-width:720px;margin:0 auto;text-align:center">
    ...
    <div style="display:flex;flex-direction:column;align-items:center;gap:0.75rem;margin-bottom:2rem">
      ...
      <span style="font-size:0.82rem;color:var(--muted)">From {price} &bull; Secure payment at booking</span>
    </div>
...
<footer class="footer">
  <div class="footer-inner">
    <div>
      ...
      <p class="footer-tagline">Professional assembly and installation services in Austin, TX and the greater Austin area.</p>
      <div class="footer-contact"><a href="mailto:service@assembleatease.com">service@assembleatease.com</a><a href="tel:+17372906129">(737) 290-6129</a></div>
    </div>
    <div>
  ...
  <div class="footer-bottom">
    <span class="footer-copy">&copy; <script>document.write(new Date().getFullYear())</script> AssembleAtEase. Austin, TX.</span>
  </div>
</footer>
</body>
</html>"""
