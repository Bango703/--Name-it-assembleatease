...
assert.match(readiness, /REQUIRED_SCHEMA_MIGRATION\s*=\s*55/);
assert.match(readiness, /DATABASE_SCHEMA_055/);
assert.match(readiness, /Apply migrations 038-055 in order/);
