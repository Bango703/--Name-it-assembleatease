...
const SERVICES = [
  ...
  },
  {
    ...
    fromPrice: '$139',
    pricingHighlights: [
      { name: 'Inversion Table', price: '$139', popular: false },
      { name: 'Treadmill Assembly', price: '$219', popular: true },
      { name: 'Elliptical Machine', price: '$239', popular: false },
  ...
  },
  {
    ...
    titleFromPrice: '$349',
    pricingHighlights: [
      { name: 'Deck box / outdoor storage bench', price: '$109', popular: false },
      { name: 'Patio umbrella + base', price: '$109', popular: false },
      { name: 'Trampoline Assembly (up to 10 ft)', price: '$319', popular: true },
      { name: 'Swing Set / Backyard Playset', price: '$349', popular: false },
...
function generatePage(city, service) {
  ...
  const pricingCount = pricingHighlights.length;
  const pricingGridClass = getBalancedPricingGridClass(pricingCount);
  const priceCards = pricingHighlights.map(p => `
...
.pricing-band-note{max-width:23rem;font-size:0.82rem;line-height:1.6;color:rgba(255,255,255,0.8);margin:0;text-align:right}
...
@media(max-width:900px){
  ...
  .pricing-band-note{text-align:left}
}
  ...
  <div class="city-hero-grid">
    <div class="city-hero-copy">
      ...
      <div class="city-hero-points">
        ...
        <span class="city-hero-point">One item or multiple rooms</span>
        <span class="city-hero-point">Detailed setup notes welcome</span>
