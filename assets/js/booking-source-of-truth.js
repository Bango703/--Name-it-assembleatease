  ...
  subcategories: {
    'Furniture Assembly': [
      { group: 'Seating & Sofas', items: [
        { name: 'Accent chair / armchair', price: 99 },
        { name: 'Sofa (2–3 seat, standard)', price: 99 },
        ...
        { name: 'Ottoman (storage)', price: 99 },
        { name: 'Bench (entryway or bedroom)', price: 99 }
      ]},
      { group: 'Bedroom', items: [
        { name: 'Bed frame — twin / full', price: 99 },
        { name: 'Bed frame — queen', price: 99, popular: true },
        ...
        { name: 'Nightstand (single)', price: 99 },
        ...
        { name: 'Vanity with mirror', price: 99 }
      ]},
      { group: 'Home Office & Study', items: [
        ...
        { name: 'Office chair (standard)', price: 99 },
        { name: 'Bookcase / shelving unit (up to 5 shelves)', price: 99 },
        { name: 'Bookcase / shelving unit (6+ shelves)', price: 99 },
        { name: 'File cabinet (2–4 drawer)', price: 99 }
      ]},
      { group: 'Dining & Kitchen', items: [
        { name: 'Dining table (standard)', price: 99 },
        { name: 'Dining table (extendable / large)', price: 109 },
        { name: 'Dining chairs (per 2 chairs)', price: 99 },
        { name: 'Dining chairs (set of 4–6)', price: 99, priceMax: 99 },
        { name: 'Bar stool (per 2 stools)', price: 99 },
        { name: 'Kitchen island (freestanding)', price: 99 },
        { name: 'China cabinet / hutch', price: 109 },
        { name: 'Buffet / sideboard', price: 99 }
      ]},
      { group: 'Living Room', items: [
        { name: 'Coffee table (simple)', price: 99 },
        { name: 'Coffee table (lift-top / storage)', price: 99 },
        { name: 'Side / end table', price: 99 },
        { name: 'TV stand / media console', price: 99 },
        { name: 'Entertainment center (large)', price: 125 },
        { name: 'Console table', price: 99 }
      ]},
      { group: 'Outdoor & Patio', items: [
        ...
        { name: 'Adirondack / Adirondack set (per 2)', price: 99 },
        { name: 'Patio umbrella + base', price: 99 },
    ...
    'Mounting & Hanging': [
      { group: 'TV Mounting by Size', items: [
        ...
        { name: 'TV 41”–55” (standard wall)', price: 99, popular: true },
        { name: 'TV 56”–65” (standard wall)', price: 99 },
      ...
      { group: 'Cable & Cord Management', items: [
        { name: 'Surface cord cover (raceway, up to 6 ft)', price: 99 },
        { name: 'In-wall cord concealment', price: 99, popular: true },
        { name: 'In-wall cord concealment (brick / concrete)', price: 115 },
        { name: 'Cable management box / hub install', price: 99 }
      ]},
      { group: 'Shelves & Wall Items', items: [
        { name: 'Floating shelf — single (up to 36”)', price: 99 },
        ...
        { name: 'Single framed picture / mirror (up to 30 lbs)', price: 99 },
        { name: 'Heavy mirror / artwork (30–80 lbs)', price: 99 },
        { name: 'Full-length mirror (floor lean / anchor)', price: 99 }
      ]},
      { group: 'Window Treatments', items: [
        { name: 'Curtain rod — 1 window', price: 99 },
        { name: 'Curtain rod — 2 windows', price: 99, popular: true },
    ...
    'Smart Home': [
      { group: 'Climate Control', items: [
        ...
        { name: 'Smart vent install (per vent)', price: 99 },
        { name: 'Smart AC controller (window / mini-split)', price: 99 },
        { name: 'Whole-home thermostat multi-zone (per zone)', price: 99 }
      ]},
      { group: 'Security & Access', items: [
        { name: 'Smart doorbell — Ring, Nest, Eufy', price: 99, popular: true },
        { name: 'Smart doorbell (hardwired replacement)', price: 99 },
        ...
        { name: 'Keypad entry install (outdoor)', price: 99 }
      ]},
      { group: 'Cameras', items: [
        { name: 'Indoor security camera (plug-in)', price: 99 },
        { name: 'Indoor camera (mount + cable manage)', price: 99 },
        { name: 'Outdoor camera — eave / soffit mount', price: 99 },
        { name: 'Outdoor camera — brick / concrete', price: 99 },
        ...
        { name: 'NVR / DVR setup + camera config', price: 99 }
      ]},
      { group: 'Lighting', items: [
        { name: 'Smart bulb install + app setup (per room, up to 4 bulbs)', price: 99 },
        { name: 'Smart switch install (per switch)', price: 99 },
        { name: 'Smart dimmer install (per switch)', price: 99 },
        { name: 'Smart plug install + setup (per 2 plugs)', price: 99 },
      ...
      { group: 'Network & Hubs', items: [
        ...
        { name: 'Wi-Fi extender / mesh node install (per node)', price: 99 },
        { name: 'Mesh network (3-node setup, full home)', price: 125 },
        { name: 'Smart home hub setup (Alexa, Google, Apple)', price: 99 },
        { name: 'Smart home hub + device automation setup', price: 115 },
        { name: 'TV streaming device setup (Apple TV, Roku, Fire)', price: 99 }
      ]},
      { group: 'Add-ons', items: [
    ...
    'Office Assembly': [
      ...
      { group: 'Conference & Specialty', items: [
        ...
        { name: 'Wall-mounted storage / overhead cabinet', price: 99 },
