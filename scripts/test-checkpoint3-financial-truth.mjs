...
assert.match(readiness, /REQUIRED_SCHEMA_MIGRATION\s*=\s*54/);
assert.match(readiness, /DATABASE_SCHEMA_054/);
assert.match(readiness, /Apply migrations 038-054 in order/);
