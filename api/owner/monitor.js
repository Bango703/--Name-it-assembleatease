...
export default async function handler(req, res) {
  ...
  const platformData = {
    ...
    alerts: {
      ...
      payablePayoutsDollars: (financeTotals.payablePayouts / 100).toFixed(2),
      connectPendingPayoutsDollars: (financeTotals.connectPendingPayouts / 100).toFixed(2),
      heldPayoutsDollars: (financeTotals.heldPayouts / 100).toFixed(2),
