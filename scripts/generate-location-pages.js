...
const SERVICES = [
  ...
  },
  {
    ...
    faqs: [
      { q: 'Do you supply the TV mount?', a: 'We can supply a standard mount for $25, or we\'ll use yours — your choice at booking.' },
      { q: 'Can you mount a TV above a fireplace?', a: 'Yes. Above-fireplace mounts include a $55 add-on for the extra height and tilt-angle work.' },
      { q: 'What wall types do you work with?', a: 'Drywall, brick, concrete, tile, and steel-stud framing. Specialty walls include a small add-on ($35–$45).' },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: 'Can you install a smart thermostat without a C-wire?', a: 'Yes. We handle no-C-wire installs using a power adapter kit, included as a $20 add-on.' },
...
<style>#cookie-banner{position:fixed;bottom:0;left:0;right:0;background:#0d1117;color:#fff;padding:1rem 2rem;z-index:9999;display:flex;align-items:center;justify-content:space-between;gap:1rem;flex-wrap:wrap;font-size:0.85rem;box-shadow:0 -4px 20px rgba(0,0,0,0.2)}#cookie-banner a{color:#00BFFF;text-decoration:underline}#cookie-banner.hidden{display:none}.cookie-btns{display:flex;gap:0.75rem;flex-shrink:0}.cookie-btn{padding:0.5rem 1.25rem;border-radius:999px;font-size:0.8rem;font-weight:600;cursor:pointer;border:none}.cookie-accept{background:#00BFFF;color:#fff}.cookie-decline{background:transparent;color:#fff;border:1.5px solid rgba(255,255,255,0.3)}</style>
</head>
<body>
