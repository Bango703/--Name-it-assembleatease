...
- [ ] **P2 · Booking step-1 empty void before selection** _(UX)_ — after the service tiles + Custom Quote there is ~600px of blank white (inline continue area, empty until a service is picked); can read as "page ended/broken." Consider a hint or reduced reserve.
