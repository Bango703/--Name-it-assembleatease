...
assert.match(readiness, /REQUIRED_SCHEMA_MIGRATION\s*=\s*37/);
assert.match(readiness, /DATABASE_SCHEMA_037/);
assert.match(readiness, /Apply migrations 034-037 in order/);
