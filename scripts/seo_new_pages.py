...
PHONE_DISPLAY = BUSINESS_IDENTITY["phoneDisplay"]
...
<section style="background:linear-gradient(135deg,#003d47,#006070);padding:5rem 2rem;text-align:center">
  <div style="max-width:600px;margin:0 auto">
    ...
    <p style="font-size:0.82rem;color:rgba(255,255,255,0.55)"><a href="tel:{PHONE}" style="color:rgba(255,255,255,0.7);text-decoration:none">{PHONE_DISPLAY}</a> &nbsp;&bull;&nbsp; <a href="mailto:service@assembleatease.com" style="color:rgba(255,255,255,0.7);text-decoration:none">service@assembleatease.com</a></p>
  </div>
</section>
...
<footer class="footer">
  <div class="footer-inner">
    <div>
      ...
      <div class="footer-contact"><a href="tel:{PHONE}">{PHONE_DISPLAY}</a><a href="mailto:service@assembleatease.com">service@assembleatease.com</a><a href="https://www.facebook.com/people/Assembleatease/61572042722009/" target="_blank" rel="noopener">Follow our project updates</a></div>
    </div>
    <div>
