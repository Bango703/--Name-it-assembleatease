...
assert.match(readiness, /REQUIRED_SCHEMA_MIGRATION\s*=\s*48/);
assert.match(readiness, /DATABASE_SCHEMA_048/);
assert.match(readiness, /Apply migrations 038-048 in order/);
