...
assert.match(readiness, /REQUIRED_SCHEMA_MIGRATION\s*=\s*66/);
assert.match(readiness, /DATABASE_SCHEMA_066/);
assert.match(readiness, /Apply migrations 038-066 in order/);
